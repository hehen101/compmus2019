...
I don't really know why, but the visualizations won't show up. I have the code and it runs without an error but the picture won't show. I'm still working on it. 
...
(The used code, maybe you can spot the problem: 
lookup <- 
    get_tidy_audio_analysis('2OtadXAUMwnv7zyZEiqq7q') %>% 
    compmus_align(bars, segments) %>% 
    select(bars) %>% unnest(bars) %>% 
