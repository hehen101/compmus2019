...
vergleich <- 
  zusammen %>%
  ggplot(aes(x = danceability, y = energy, size = acousticness, label = artist_name, label = track_name)) + 
...
### Chroma feature: Outlier - Look Up And See Infinity, Look Down And See Nothing
